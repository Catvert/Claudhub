...
impl ClaudhubApp {
    ...
    ///
    /// Split out for the panels that name themselves: the magnifier in a bar
    /// knows which panel it belongs to, where `Ctrl+F` asks the click.
    /// Returns the field so the caller can seed it.
